...
-- (20260825100000_...) que usaba un timestamp inventado que no coincidia
...
-- archivo usa el version real: 20260825191629.
--
-- Regla: solo precio regular, nunca promocional. WorldRemit AU->IN y AU->PK
-- se probaron con multiples montos y metodos de entrega y SIEMPRE mostraron
-- banner promocional sin forma de ver tasa regular -- excluidos, no se
-- insertan filas para esos dos corredores.
--
-- Convencion de signo: spread = (mid_rate - tasa_ofrecida) / mid_rate * 100.
-- Positivo = cliente recibe menos que mid-market (costo). Negativo = recibe
-- mas (premium). Mid-market de referencia: xe.com, 25-ago-2026.
...
('EUR','PLN',4.22,3.99,'moneygram','DE','PL',false,2.04,0.01,null,'moneygram.com/de/en/corridor/poland, widget de home, 500 EUR. Banner explicito "Special rate on your first transfer! 1 EUR = 4.30 PLN" y "No fees for new customers" (fee tachado 3.99->0.00) -- se carga el valor regular tachado (4.22 PLN / 3.99 EUR). Checkout completo requiere crear cuenta, no se pudo confirmar en flujo completo. Mid-market xe.com 4.30786601 (06:53 UTC)','2026-08-25','confirmado_activo'),
