...
alter table public.providers
  add column min_amount_estimated boolean not null default false,
  add column settlement_terms_estimated boolean not null default false,
  add column contract_type_estimated boolean not null default false;
