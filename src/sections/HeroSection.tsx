...
/** Horizontal hero: centered one-line headline + one-line subtitle, full
 *  width. The trust points (live rates, zero fees, no sign-up) live inside
 *  the subtitle text — no badge pills. The unified comparator box
 *  (ComparatorSection) sits directly below. */
