...
const HOME_SECTIONS_KEYS: Partial<Record<Lang, Dict>> = {
  en: {
    ...
    "home.cta.subtitle": "Direct access to our multi-currency infrastructure, private RFQ protocols and dedicated coverage for corporate FX programmes and high-volume cross-border flows.",
    ...
    "home.how.s1.desc": "Real-time scan of liquidity paths and provider rates.",
    "home.how.s2.title": "Optimise",
    "home.how.s2.desc": "Neutral AI ranks speed, cost and reliability — no bias.",
  ...
  es: {
    ...
    "home.cta.subtitle": "Acceso directo a nuestra infraestructura multidivisa, protocolos privados de RFQ y cobertura dedicada para programas corporativos de FX y flujos transfronterizos de alto volumen.",
...
const EXTRA_KEYS: Partial<Record<Lang, Dict>> = {
  en: {
    ...
    "comparator.copilot.proactive.rate": "I noticed **{provider}** offers the best rate right now for this amount. Want me to help you proceed?",
    "comparator.copilot.proactive.fee": "Heads up: **{provider}** has the lowest total fees for this amount. Ready to continue?",
    "comparator.copilot.proactive.speed": "**{provider}** is the fastest option for this corridor right now. Want to proceed?",
    "comparator.copilot.filterReact": "I see you filtered by **{filter}** — here are the best brokers for that selection:",
    ...
    "search.destination": "Destination country",
    ...
    "search.cta": "Continue",
    "search.destinationPrompt": "Destination: Select the recipient country.",
    "search.guide": "Select your destination country and choose between individual or business account. For local currency exchange, select your current country. Our AI Agent will immediately compare providers and real-time market rates to help you decide.",
    ...
    "comparator.copilot.business.volumeError": "Please include both an estimated monthly volume and your sector.",
    "comparator.copilot.business.email": "Thank you. Based on this route, **{providers}** are currently among the strongest market alternatives. To send you a detailed summary and connect you with specialists who can assess these conditions, please confirm your corporate email.",
    "comparator.copilot.business.emailError": "Please provide a valid corporate email address.",
    "comparator.copilot.business.consent": "By confirming, you agree that we may share this quote request with the selected providers so they can offer their best rate. Is that correct?",
    ...
    "comparator.transferDetails.subtitle": "Adjust the amount and currencies before running the market comparison.",
  ...
  es: {
    ...
    "comparator.copilot.business.email": "Gracias. Para esta ruta, **{providers}** están actualmente entre las alternativas más competitivas del mercado. Para enviarte un resumen detallado y conectarte con especialistas que puedan evaluar estas condiciones, confírmame tu email corporativo.",
    "comparator.copilot.business.emailError": "Introduce un email corporativo válido.",
    "comparator.copilot.business.consent": "Al confirmar, aceptas que compartamos esta solicitud de cotización con los proveedores seleccionados para que puedan ofrecerte su mejor tasa. ¿Es correcto?",
    ...
    "comparator.transferDetails.subtitle": "Ajusta el importe y las monedas antes de ejecutar la comparación de mercado.",
    ...
    "comparator.cta.compareRates": "Comparar tasas",
