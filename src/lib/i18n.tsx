...
export const DICTS: Record<Lang, Dict> = {
  en: {
    ...
    "home.how.s1.title": "Select your corridor",
    "home.how.s1.desc": "Choose origin and destination countries plus currencies.",
    "home.how.s2.title": "Run the comparison",
    "home.how.s2.desc": "Our AI engine scans 50+ providers simultaneously in real time.",
    "home.how.s3.title": "Pick the best offer",
    "home.how.s3.desc": "See a transparent breakdown: rate, fees, speed, and total received.",
    "home.how.s4.title": "Transfer directly",
    "home.how.s4.desc": "Go straight to the provider, no middleman, no extra margin.",
    ...
    "home.about.vision.body": "A world where every local FX or cross-border payment, from a family remittance to a multinational treasury operation, runs through a transparent and equitable decision layer.",
    "home.about.problem.label": "Problem",
    "home.about.problem.body": "A two-sided inefficiency. On one side, retail clients and businesses face a frustrating maze regarding best rates. On the other, financial institutions struggle with high acquisition costs and fragmented channels.",
    // Home — Stats / Market coverage
    "home.stats.eyebrow": "Market coverage",
    "home.stats.title": "One view across the global FX market.",
    "home.stats.subtitle": "Our decision engine evaluates more than 50 global providers in real time, normalizing rates, fees, delivery speed and corridor availability into a clear comparison.",
    ...
    "home.contact.treasury.body": "We can develop custom, on-premise AI agents as a service, tailored to your corporate treasury team's workflow to optimize trade finance and liquidity operations.",
    "home.contact.partners.title": "For FX & Payment Partnerships",
    "home.contact.partners.body": "We are looking to align with cross-border payment operators and currency exchange providers; let's explore synergies through integrated sponsored placements and affiliate programs designed to maximize efficiency and reduce your Customer Acquisition Cost (CAC).",
    // Home — Blog
    "home.blog.eyebrow": "Blog",
    "home.blog.title": "Insights on global FX, coming soon.",
    "home.blog.body": "We're preparing in-depth analysis on cross-border payments, corridor economics, and FX intelligence. Check back soon.",
    // Footer
    ...
    "legal.terms.intro": "These Terms govern your access to and use of Mangomundi. By using the service you accept these Terms.",
    "legal.terms.h1": "01 — Service",
    "legal.terms.p1": "Mangomundi is a neutral decision engine that compares foreign exchange providers and corridors. We do not execute transactions or hold customer funds.",
    "legal.terms.h2": "02 — Information accuracy",
    "legal.terms.p2": "Quotes and provider data are sourced in real time from third parties. Final terms are governed by each provider at execution.",
    "legal.terms.h3": "03 — Acceptable use",
    "legal.terms.p3": "You agree to use the service only for lawful purposes and to not misuse the platform, attempt to interfere with its operation, or scrape data without permission.",
    "legal.terms.h4": "04 — Liability",
    "legal.terms.p4": "The service is provided on an \"as is\" basis. To the maximum extent permitted by law, Mangomundi is not liable for indirect or consequential losses arising from use of the service.",
    ...
    "legal.risk.intro": "Foreign exchange markets are volatile. Quoted rates, fees and delivery times can change between comparison and execution.",
    "legal.risk.h1": "01 — Market risk",
    "legal.risk.p1": "Exchange rates fluctuate continuously. Comparisons shown are indicative at the moment of query and may differ from the rate offered by a provider at the moment of execution.",
    "legal.risk.h2": "02 — Counterparty risk",
    "legal.risk.p2": "Transactions are executed by the provider you select. Mangomundi does not guarantee the performance, solvency or regulatory status of any third-party provider.",
    "legal.risk.h3": "03 — Regulatory variation",
    "legal.risk.p3": "Availability of corridors and providers varies by jurisdiction. You are responsible for ensuring use of a provider complies with local laws.",
    "legal.risk.h4": "04 — No financial advice",
    "legal.risk.p4": "Information presented is for comparison purposes only and does not constitute financial, tax, or legal advice.",
    "legal.privacy.title": "Privacy Policy",
    "legal.privacy.intro": "We collect only what we need to operate the comparison engine and improve the product. We do not sell personal data.",
    "legal.privacy.h1": "01 — Data we collect",
    "legal.privacy.p1": "Query parameters (corridor, amount, segment), basic device and geolocation signals, and any information you voluntarily provide via inquiry forms.",
    "legal.privacy.h2": "02 — How we use it",
    "legal.privacy.p2": "To return relevant comparisons, improve accuracy of the decision engine, and respond to partnership or institutional inquiries.",
    "legal.privacy.h3": "03 — Sharing",
    "legal.privacy.p3": "We share data with sub-processors strictly necessary to operate the service (e.g. hosting, analytics). We never sell personal data.",
    "legal.privacy.h4": "04 — Your rights",
    "legal.privacy.p4": "You can request access, correction, or deletion of your personal data by writing to hello@mangomundi.com.",
  },
  es: {
    "nav.home": "Inicio",
    ...
    "home.how.s1.title": "Elegí tu corredor",
    "home.how.s1.desc": "Seleccioná los países de origen y destino junto con las divisas.",
    "home.how.s2.title": "Ejecutá la comparación",
    "home.how.s2.desc": "Nuestro motor de IA escanea más de 50 proveedores en tiempo real simultáneamente.",
    "home.how.s3.title": "Elegí la mejor oferta",
    "home.how.s3.desc": "Mirá un desglose transparente: tasa, comisiones, velocidad y total recibido.",
    "home.how.s4.title": "Transferí directamente",
    "home.how.s4.desc": "Andá directo al proveedor, sin intermediarios ni márgenes extra.",
    // Home — About / Manifiesto
    "home.about.eyebrow": "Nosotros",
    "home.about.title": "Inteligencia financiera para cada decisión de divisas.",
    "home.about.subtitle": "Un motor de decisión neutral: conectamos flujos retail y corporativos con la mejor ruta transfronteriza o el mejor operador local de cambio, sin sesgos ni márgenes ocultos.",
    "home.about.mission.label": "Misión",
    "home.about.mission.body": "Facilitar el acceso a las mejores decisiones de cambio mediante inteligencia neutral impulsada por IA, eliminando la asimetría de información y los costos ocultos de los pagos globales.",
    "home.about.vision.label": "Visión",
    "home.about.vision.body": "Un mundo donde cada pago local o transfronterizo, desde una remesa familiar hasta una operación de tesorería multinacional, transite por una capa de decisión transparente y equitativa.",
    "home.about.problem.label": "Problema",
    "home.about.problem.body": "Una ineficiencia de doble cara. Por un lado, clientes retail y empresas enfrentan un laberinto frustrante para encontrar las mejores tasas. Por el otro, las instituciones financieras enfrentan altos costos de adquisición y canales fragmentados.",
    ...
    "home.stats.subtitle": "Nuestro motor de decisión evalúa más de 50 proveedores globales en tiempo real, normalizando tasas, comisiones, velocidad de entrega y disponibilidad por corredor en una comparación clara.",
    ...
    "home.contact.treasury.body": "Desarrollamos agentes de IA personalizados, on-premise, adaptados al flujo de trabajo de tu equipo de tesorería corporativa para optimizar operaciones de financiamiento comercial y liquidez.",
    "home.contact.partners.title": "Para partnerships de FX y pagos",
    "home.contact.partners.body": "Buscamos alinearnos con operadores de pagos transfronterizos y proveedores de cambio de divisas; exploremos sinergias mediante colocaciones patrocinadas integradas y programas de afiliados diseñados para maximizar eficiencia y reducir tu Costo de Adquisición de Clientes (CAC).",
    // Home — Blog
    "home.blog.eyebrow": "Blog",
    "home.blog.title": "Análisis sobre FX global, muy pronto.",
    "home.blog.body": "Estamos preparando análisis en profundidad sobre pagos transfronterizos, economía de corredores e inteligencia FX. Volvé pronto.",
    // Footer
    ...
    "legal.terms.intro": "Estos Términos rigen tu acceso y uso de Mangomundi. Al utilizar el servicio aceptás estos Términos.",
    "legal.terms.h1": "01 — Servicio",
    "legal.terms.p1": "Mangomundi es un motor de decisión neutral que compara proveedores y corredores de cambio. No ejecutamos transacciones ni custodiamos fondos de clientes.",
    "legal.terms.h2": "02 — Exactitud de la información",
    "legal.terms.p2": "Las cotizaciones y datos de proveedores se obtienen en tiempo real de terceros. Los términos finales se rigen por cada proveedor al momento de la ejecución.",
    "legal.terms.h3": "03 — Uso aceptable",
    "legal.terms.p3": "Aceptás utilizar el servicio únicamente para fines lícitos y no hacer uso indebido de la plataforma, interferir con su funcionamiento o extraer datos sin autorización.",
    "legal.terms.h4": "04 — Responsabilidad",
    "legal.terms.p4": "El servicio se brinda \"tal cual\". En la máxima medida permitida por la ley, Mangomundi no es responsable por pérdidas indirectas o consecuentes derivadas del uso del servicio.",
    ...
    "legal.risk.intro": "Los mercados de cambio son volátiles. Las tasas, comisiones y tiempos de entrega cotizados pueden cambiar entre la comparación y la ejecución.",
    "legal.risk.h1": "01 — Riesgo de mercado",
    "legal.risk.p1": "Los tipos de cambio fluctúan continuamente. Las comparaciones mostradas son indicativas al momento de la consulta y pueden diferir de la tasa ofrecida por un proveedor al momento de la ejecución.",
    "legal.risk.h2": "02 — Riesgo de contraparte",
    "legal.risk.p2": "Las transacciones las ejecuta el proveedor que elijas. Mangomundi no garantiza el desempeño, solvencia ni estado regulatorio de ningún proveedor externo.",
    "legal.risk.h3": "03 — Variación regulatoria",
    "legal.risk.p3": "La disponibilidad de corredores y proveedores varía según la jurisdicción. Sos responsable de asegurar que el uso de un proveedor cumpla con las leyes locales.",
    "legal.risk.h4": "04 — No es asesoramiento financiero",
    "legal.risk.p4": "La información presentada es solo a efectos comparativos y no constituye asesoramiento financiero, fiscal ni legal.",
    "legal.privacy.title": "Política de Privacidad",
    "legal.privacy.intro": "Recolectamos solo lo necesario para operar el motor de comparación y mejorar el producto. No vendemos datos personales.",
    "legal.privacy.h1": "01 — Datos que recolectamos",
    "legal.privacy.p1": "Parámetros de consulta (corredor, monto, segmento), señales básicas de dispositivo y geolocalización, y cualquier información que proporciones voluntariamente en formularios de contacto.",
    "legal.privacy.h2": "02 — Cómo los usamos",
    "legal.privacy.p2": "Para devolver comparaciones relevantes, mejorar la precisión del motor de decisión y responder consultas institucionales o de partnerships.",
    "legal.privacy.h3": "03 — Compartición",
    "legal.privacy.p3": "Compartimos datos con sub-procesadores estrictamente necesarios para operar el servicio (p. ej. hosting, analítica). Nunca vendemos datos personales.",
    "legal.privacy.h4": "04 — Tus derechos",
    "legal.privacy.p4": "Podés solicitar acceso, corrección o eliminación de tus datos personales escribiendo a hello@mangomundi.com.",
  },
  pt: {
    "nav.home": "Início",
