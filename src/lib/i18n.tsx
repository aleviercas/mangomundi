...
const PAGE_KEYS: Partial<Record<Lang, Dict>> = {
  en: {
    ...
    "blog.cta.button": "Go to compare",
    "blog.sponsored.heading": "Send money with our partners",
    "blog.sponsored.disclosure":
      "Sponsored — mangomundi may earn a commission at no extra cost to you.",
    "blog.sponsored.sendWith": "Send money with",
  ...
  es: {
    ...
    "blog.cta.button": "Ir a comparar",
    "blog.sponsored.heading": "Enviá dinero con nuestros socios",
    "blog.sponsored.disclosure":
      "Patrocinado — mangomundi puede recibir una comisión sin costo adicional para vos.",
    "blog.sponsored.sendWith": "Enviar dinero con",
    "blog.sponsored.forBusiness": "para tu negocio",
    "blog.sponsored.forIndividuals": "para personas",
...
const EXTRA_KEYS: Partial<Record<Lang, Dict>> = {
  en: {
    ...
    "comparator.copilot.proactive.generic":
      "**{provider}** stands out on **{criterion}** for this corridor. Want to proceed?",
    ...
    "comparator.sortBy": "Sort",
    "comparator.filterBy": "Require",
    "comparator.delivery.all": "All methods",
    "comparator.delivery.bankTransfer": "Bank",
    "comparator.delivery.cashPickup": "Cash",
    "comparator.delivery.cardPayout": "Card",
    "comparator.delivery.broker": "Broker",
    "comparator.delivery.bestDeal": "Best deal",
    "comparator.sort.received": "Best rate",
    "comparator.sort.fee": "Fees",
    "comparator.sort.speed": "Speed",
    ...
    "agent.newResult": "New result available — tap to view",
  ...
  es: {
    ...
    "agent.newResult": "Nuevo resultado disponible — tocá para verlo",
...
// Keys are route paths matching TanStack Router pathnames. Covers only the
// routes that are actual distinct pages today: "/blog" (index) and "/legal".
// Home ("/") gets its title/description from SEO_META directly (see
// __root.tsx); blog POSTS get their own dynamic per-post title from the post
// content itself (see blog_.$slug.tsx) — neither needs an entry here.
// All 20 site languages are covered; getRouteSeo() falls back to SEO_META[lang]
// (then English) for any route/language combination missing below.
