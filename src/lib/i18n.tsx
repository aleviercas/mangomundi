...
const EXTRA_KEYS: Partial<Record<Lang, Dict>> = {
  en: {
    ...
    "search.destination": "Destination: Select the recipient country.",
    ...
    "comparator.copilot.business.email": "Thank you. For this volume, the best institutional rates are currently **{providers}**. Please confirm your corporate email to continue.",
    "comparator.copilot.business.emailError": "Please provide a valid corporate email address.",
    "comparator.copilot.business.consent": "GDPR consent: by confirming, you agree that mangoglobal may store these details and share this quote request with selected providers. Is that correct?",
  ...
  es: {
    ...
    "comparator.copilot.business.email": "Gracias. Con este volumen, las mejores tarifas institucionales son **{providers}**. Confirma tu email corporativo para continuar.",
    "comparator.copilot.business.emailError": "Introduce un email corporativo válido.",
    "comparator.copilot.business.consent": "Consentimiento GDPR: al confirmar, aceptas que mangoglobal guarde estos datos y comparta la solicitud con los proveedores seleccionados. ¿Es correcto?",
