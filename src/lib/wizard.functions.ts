// 2026-09-12 — split out of src/components/AiCopilot.tsx: that file mixing
// two real components (AiCopilot, MissingCorridorCta) with a pile of
// non-component exports (types, the DEFAULT_WIZARD_ACTIONS constant,
// resolveWizardLocale, every local* zero-AI reply builder, buildWizardContext)
// triggered react-refresh/only-export-components repeatedly. Moved
// everything that isn't a component here; AiCopilot.tsx now only exports
// components. Behavior is unchanged — same functions, same exports, just a
// different file (src/sections/ComparatorSection.tsx, the only importer,
// updated to pull components from @/components/AiCopilot and everything
// below from here).
import {
  Info,
  Calculator,
