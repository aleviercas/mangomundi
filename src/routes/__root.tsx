  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ddb96425-43ac-415e-a206-ac102e84ad47/id-preview-7e5dfc28--7dc2543e-201c-4adf-b044-0b020dfdced9.lovable.app-1781742686938.png" },
        { property: "og:site_name", content: "mangomundi" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:site", content: "@mangomundi" },
        { name: "twitter:title", content: seo.title },
        { name: "twitter:description", content: seo.description },
        { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ddb96425-43ac-415e-a206-ac102e84ad47/id-preview-7e5dfc28--7dc2543e-201c-4adf-b044-0b020dfdced9.lovable.app-1781742686938.png" },
        { title: "Lovable App" },
