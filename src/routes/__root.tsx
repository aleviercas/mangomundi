  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/hA4co5Od47W2b9ad07ze93fKA903/social-images/social-1781798072784-og-image.webp" },
        { property: "og:site_name", content: "mangomundi" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:site", content: "@mangomundi" },
        { name: "twitter:title", content: seo.title },
        { name: "twitter:description", content: seo.description },
        { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/hA4co5Od47W2b9ad07ze93fKA903/social-images/social-1781798072784-og-image.webp" },
        { title: "Mangomundi" },
