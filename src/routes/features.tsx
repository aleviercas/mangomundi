...
// con servidor real): sin esto, "/features?lang=es" perdia el idioma y
...
// site's nav/footer, and not referenced by any component. Kept as a
// redirect (not deleted outright) so any old bookmark, backlink, or
